...
"""
################################################################################
api_id = 14536506 # ایدی مخصوص اکانت خودتون قرار بدید
api_hash = "95c279eb3efc8eeb5e439ecee513d1e7" #هش مخصوص اکانت خودتون قرار بدید
...
#eturn datetime.now().strftime('%H:%M')
#
#
...
#    draw.text(((W - wt) / 2, (H - ht) / 2 ), text, font=font, fill=choice(["#00c7a4","#0071c7","#c7a200","#728593","#943633","#6495ed","#43f70a","#e1b2ae","#527130","#629f5d","#3d4
